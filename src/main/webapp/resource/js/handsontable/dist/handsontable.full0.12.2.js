...
//  instance.rootElement.addClass('handsontable');
  ...
  this.eventManager.addEventListener(document.documentElement, 'mouseup', function (event) {
	...
	//fix ie problem by ym at 20150522 pm
	if(event.which == undefined){
		if (instance.selection.isInProgress() && event.keyCode === 0){
			instance.selection.finish();
		}
	}
      ...
      items: [
        {
		  ...
		  name:$.i18n.prop('table.toolbar.rowAbove'),
        ...
        },
        {
		  ...
		  name: $.i18n.prop('table.toolbar.rowBelow'),
          callback: function (key, selection) {
        ...
        ContextMenu.SEPARATOR,
        {
		  ...
		  name: $.i18n.prop('table.toolbar.colLeft'),
          callback: function (key, selection) {
        ...
        },
        {
		  ...
		  name: $.i18n.prop('table.toolbar.colRight'),
          callback: function (key, selection) {
        ...
        ContextMenu.SEPARATOR,
        {
          key: 'remove_row',
          //name: 'Remove row',
		  name: $.i18n.prop('table.toolbar.removeRow'),
          callback: function (key, selection) {
        ...
        },
        {
          key: 'remove_col',
          //name: 'Remove column',
		  name: $.i18n.prop('table.toolbar.removeCol'),
          callback: function (key, selection) {
        ...
        ContextMenu.SEPARATOR,
        {
          key: 'undo',
          //name: 'Undo',
		  name: $.i18n.prop('table.toolbar.undo'),
          callback: function () {
            this.undo();
          },
          disabled: function () {
        ...
        },
        {
          key: 'redo',
          //name: 'Redo',
		  name: $.i18n.prop('table.toolbar.redo'),
          callback: function () {
            this.redo();
          },
          disabled: function () {
        ...
        ContextMenu.SEPARATOR,
        {
          ...
          name: function () {
            //var label = "Read only";
			var label = $.i18n.prop('table.toolbar.readOnly');
        ...
        ContextMenu.SEPARATOR,
        {
          key: 'alignment',
          //name: 'Alignment',
		  name: $.i18n.prop('table.toolbar.alignment'),
          submenu: {
            items: [
              {
                name: function () {
                  //var label = "Left";
				  var label = $.i18n.prop('table.toolbar.alignment.left');
              ...
              },
              {
                name: function () {
                  //var label = "Center";
				  var label = $.i18n.prop('table.toolbar.alignment.right');
              ...
              },
              {
                name: function () {
                  //var label = "Right";
				  var label = $.i18n.prop('table.toolbar.alignment.center');
              ...
              },
              {
                name: function () {
                  //var label = "Justify";
				  var label = $.i18n.prop('table.toolbar.alignment.justify');
              ...
              ContextMenu.SEPARATOR,
              {
                name: function () {
                  //var label = "Top";
				  var label = $.i18n.prop('table.toolbar.alignment.top');
              ...
              },
              {
                name: function () {
                  //var label = "Middle";
				  var label = $.i18n.prop('table.toolbar.alignment.middle');
              ...
              },
              {
                name: function () {
                  //var label = "Bottom";
				  var label = $.i18n.prop('table.toolbar.alignment.bottom');
  ...
  defaultOptions.items.push({
    ...
    name: function () {
      ...
      if (info) {
		...
		return $.i18n.prop('table.toolbar.unmerge');
      }
      else {
        //return 'Merge cells';
		return $.i18n.prop('table.toolbar.merge');
      }
    },
    callback: function () {
      this.mergeCells.mergeOrUnmergeSelection(this.getSelectedRange());
...
(function (Handsontable) {
/**
   *  extend the contexMenu for set editor group by ym
   */
  function ReportGroupMenu(){
	this.instance = null;
  }
   ...
   */
  ReportGroupMenu.prototype.addToContextMenu = function (defaultOptions) {
    if (!this.getSettings().reportGroupMenu) {
      return;
    }
    defaultOptions.items.unshift(
      {
        key: 'setToCondition',
        //name: 'Set To Condition',
		name: $.i18n.prop('table.toolbar.setToCondition'),
		callback: function () {
          $('.area').attr("title","conditions");
		  return false;
        }
      },
      {
        key: 'setToHeader',
        //name: 'Set To Header',
		name: $.i18n.prop('table.toolbar.setToHeader'),
        callback: function () {
          $('.area').attr("title","headers");
		  return false;
        }
      },
	  {
        key: 'clear to null',
        //name: 'clear',
		name: $.i18n.prop('table.toolbar.clear'),
        callback: function () {
  ...
  ReportGroupMenu.prototype.bindEvents = function () {
    var plugin = this;
  ...
  ReportGroupMenu.prototype.setup = function (cmInstance) {
	reportGroupMenu.bindEvents();
  };

  ReportGroupMenu.prototype.init = function () {

    rportGroupMenu.instance = this;
  };
  ...
  var reportGroupMenu = new ReportGroupMenu();

  Handsontable.hooks.add('afterRender', function () {
    reportGroupMenu.setup(this);
  });
  ...
  Handsontable.hooks.add('afterContextMenuDefaultOptions', reportGroupMenu.addToContextMenu);
  Handsontable.ReportGroupMenu = ReportGroupMenu;
...
WalkontableTable.prototype.draw = function (fastDraw) {
  ...
  if (!fastDraw) {
    ...
    if (this.instance.cloneOverlay instanceof WalkontableDebugOverlay
	  ...
	  if(this.instance && this.instance.wtViewport && this.instance.wtViewport.rowsPreCalculator)
		renderStartRow = this.instance.wtViewport.rowsPreCalculator.renderStartRow;
    }
...
WalkontableTable.prototype.getRenderedColumnsCount = function () {
  ...
  if (isClone && (this.instance.cloneOverlay instanceof WalkontableHorizontalScrollbarNative || this.instance.cloneOverlay instanceof WalkontableCornerScrollbarNative)) {
	...
	if(this.getColumnStrategy() != null)
...
WalkontableTableRenderer.prototype.render = function () {
  ...
  var visibleColIndex
	...
	, workspaceWidth, cloneLimit;
	if(this.instance && this.instance.wtViewport && this.instance.wtViewport.rowsPreCalculator && this.instance.wtViewport.rowsPreCalculator.countRendered)
		cloneLimit = this.instance.wtViewport.rowsPreCalculator.countRendered;
...
WalkontableTableRenderer.prototype.renderRows = function (totalRows, cloneLimit, displayTds) {
  ...
  while (sourceRowIndex < totalRows && sourceRowIndex >= 0) {
    ...
    if (TR.firstChild) {
      ...
      if (height) {
        TR.firstChild.style.height = (height-4) + 'px';
      }
      else {
