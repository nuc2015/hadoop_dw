		...
		this.init=function()
		{
			...
			$.each(settings.tools,function(i,n)
			{
				...
				else
				{
					...
					arrToolsHtml.push('<span><a href="#" idx="'+tool.idx+'" title="{#'+tool.t+'}" cmd="'+n+'" class="xheButton xheEnabled" tabindex="-1" role="button"><span class="'+cn+'" unselectable="on" style="font-size:0;color:transparent;text-indent:-999px;">'+tool.t+'</span></a></span>');
