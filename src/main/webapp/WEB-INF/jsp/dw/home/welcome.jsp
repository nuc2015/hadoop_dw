                ...
                <div class="panel-body">
                    <div class="commentbox">
                        <ul class="commentList">
                            <li class="item cl"> <a href="javascript:;"><i class="avatar size-L radius"><img alt="" src="${ctx}"></i></a>
                                <div class="comment-main">
                                    <header class="comment-header">
                                        <div class="comment-meta"><a class="comment-author" href="javascript:;">慕枫</a> 评论于
                                            <time title="2014年8月31日 下午3:20" datetime="2014-08-31T03:54:20">2014-8-31 15:20</time>
                                        </div>
                                    </header>
                                    <div class="comment-body">
                                        <p><a href="javascript:;">@某人</a> 系统真不错！！！</p>
                                    </div>
                                </div>
                            </li>
                            <li class="item cl"> <a href="javascript:;"><i class="avatar size-L radius"><img alt="" src="${ctx}"></i></a>
...
<script src="${ctx}/static/admin/lib/echarts/echarts.js"></script>
<script type="text/javascript">
    layui.use(['layer','jquery'], function(){
        ...
        require.config({
            paths: {
                echarts: '${ctx}/static/admin/lib/echarts'
            }
        });
        require(
            [
