package cn.edu.llxy.dw.dssframework.hibernate4.dao.impl;
...
//		return (Long) this.getCurrentSession().createQuery(hql).uniqueResult();
	...
	public String getDialect() {
		SessionFactoryImpl factoryImpl = (SessionFactoryImpl)this.getSessionFactory();
		return factoryImpl.getDialect().getClass().getName();
	}

	public List<T> queryByHql(String hql, Object... values) {
		return createHqlQuery(this.getCurrentSession(), hql, values).list();
	}
