package cn.edu.llxy.dw.dss.cfg;
...
public class Const {
	...
	/**
	 * HBase查询在界面上默认显示数据记录条数
	 */
	public static final int HBASE_DISPLAY_ROW = 50;

	/**
	 * HBase每次查询返回的记录条数
	 */
	public static final int HBASE_NUMBER_ROW = 10;
...
//		System.out.println(ParseHexStrToShort("aa"));
//	}
}
