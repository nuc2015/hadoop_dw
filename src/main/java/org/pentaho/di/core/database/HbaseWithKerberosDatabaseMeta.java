...
@DatabaseMetaPlugin( type = "HbaseKBS", typeDescription = "Hadoop Hbase with kerberos" )
public class HbaseWithKerberosDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
...
public HbaseWithKerberosDatabaseMeta() throws Throwable {
  }
   ...
   * @throws Throwable
   */
HbaseWithKerberosDatabaseMeta( int majorVersion, int minorVersion ) throws Throwable {
